    ...
    async def _ensure_config_rows(self, db, config_dict: dict = None):
        ...
        if count[0] == 0:
            ...
            if config_dict:
                ...
                flow_captcha_service_base_url = captcha_config.get("flow_captcha_service_base_url", "http://223.167.72.194:35201")
                flow_captcha_service_solve_path = captcha_config.get("flow_captcha_service_solve_path", "/api/v1/captcha/solve")
                flow_captcha_service_api_key = captcha_config.get("flow_captcha_service_api_key", "")
                flow_captcha_service_timeout_seconds = captcha_config.get("flow_captcha_service_timeout_seconds", 120)
            ...
            """, (
                ...
                flow_captcha_service_api_key,
                flow_captcha_service_timeout_seconds,
            ))
            ...
            if row:
                ...
                await db.execute("""
                    INSERT INTO captcha_config (id, captcha_method, yescaptcha_api_key, yescaptcha_base_url,
                        ...
                        capsolver_api_key, capsolver_base_url, flow_captcha_service_base_url,
                        flow_captcha_service_solve_path, flow_captcha_service_api_key,
                        flow_captcha_service_timeout_seconds, browser_proxy_enabled, browser_proxy_url, browser_count)
                    VALUES (1, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                """, (new_method, new_yes_key, new_yes_url, new_cap_key, new_cap_url,
                      new_ez_key, new_ez_url, new_cs_key, new_cs_url,
                      new_flow_base_url, new_flow_solve_path, new_flow_api_key, new_flow_timeout,
